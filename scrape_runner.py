...
def main():
    ...
    try:
        ...
        while True:
            response = input(f"How many players to scrape? (1-{total_players}, or 'all'): ").strip()
        ...
        delay = float(input("Delay between requests in seconds (recommended: 2): ") or "2")
        ...
        if scraper.scraped_data:
            print(f"Saving {len(scraper.scraped_data)} players scraped so far...")
